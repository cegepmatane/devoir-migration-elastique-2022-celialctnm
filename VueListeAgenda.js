class VueListeAgenda{
    ...
    afficher(){
        ...
        for(var numeroAgenda in this.listeAgendaDonnee){
            ...
            listeAgendaItemHTMLRemplacement = listeAgendaItemHTMLRemplacement.replaceAll("{Agenda.id}",this.listeAgendaDonnee[numeroAgenda].id);
            listeAgendaItemHTMLRemplacement = listeAgendaItemHTMLRemplacement.replaceAll("{Agenda.matiere}",this.listeAgendaDonnee[numeroAgenda].matiere);
